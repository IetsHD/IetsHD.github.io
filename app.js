// ====== Demo producten ======
const PRODUCTS = [
  { id: "p1", name: "Strawberry Shortcake Senpai", price: 80, category: "Blush Bakery" },
  { id: "p2", name: "Choco Neko Brownie", price: 80, category: "Blush Bakery" },
  { id: "p3", name: "Berry Blush Ceesecake", price: 80, category: "Blush Bakery" },
  { id: "p4", name: "Meowchi Mochi Ice Cream", price: 80, category: "Blush Bakery" },
  { id: "p5", name: "Sakura Pancakes", price: 80, category: "Fluffy Bites" },
  { id: "p6", name: "Bananabear Stack", price: 80, category: "Fluffy Bites" },
  { id: "p7", name: "Honey Dream", price: 80, category: "Fluffy Bites" },
  { id: "p8", name: "Avoda-Toastie Chan", price: 80, category: "Snacku" },
  { id: "p9", name: "Cheesy Senpai Melt", price: 80, category: "Snacku" },
  { id: "p10", name: "Kawaii Breakfast Plate", price: 80, category: "Snacku" },
  { id: "p11", name: "Pink Milk UWU", price: 80, category: "Cozy Drinks" },
  { id: "p12", name: "Matcha Magic Latte", price: 80, category: "Cozy Drinks" },
  { id: "p13", name: "Sweethearth Cappuccino", price: 80, category: "Cozy Drinks" },
  { id: "p14", name: "RaccooPuffuCappu-Chan", price: 80, category: "Cozy Drinks" },
  { id: "p15", name: "Boba Kiwi Tea", price: 80, category: "Cozy Drinks" },
  { id: "p16", name: "Boba Strawberrie Tea", price: 80, category: "Cozy Drinks" },
  { id: "p17", name: "Boba Cutie Tea", price: 80, category: "Cozy Drinks" },
  { id: "p18", name: "Barkie Bites", price: 20, category: "Woofie Menu" },
  { id: "p19", name: "Woofie Crunchies", price: 20, category: "Woofie Menu" },
  { id: "p20", name: "Puppuccino", price: 20, category: "Woofie Menu" },
  { id: "p21", name: "YUm Yum Pup Water", price: 20, category: "Woofie Menu" },
];
